...
# Carregar os dados da tabela 'mercdolivre_items' em um Dataframe pandas
...
st.subheader('Marcas mais encontradas até a 10º página')
col1, col2 = st.columns([4,2])
top_10_pages = df['brand'].value_counts().sort_values(ascending=False)
col1.bar_chart(top_10_pages)
col2.write(top_10_pages)
